...
const Profile: NextPage = () => {
	return (
		<>
			<Layout tabBarOn title="내 프로필">
				<div className="px-4">
					<div className="flex items-center mt-4 space-x-3">
						<div className="w-16 h-16 bg-slate-500 rounded-full" />
						<div className="flex flex-col">
							<span className="font-medium text-gray-900">원철</span>
					...
					<div className="mt-12">
						<div className="flex space-x-4 items-center">
							...
							<div>
								<h4 className="text-sm font-bold text-gray-800">brown</h4>
						...
						<div className="mt-4 px-2 text-gray-600 text-sm">
							<p>리뷰자리</p>
						</div>
					</div>
				</div>
